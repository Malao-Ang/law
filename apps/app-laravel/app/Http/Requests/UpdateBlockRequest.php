...
class UpdateBlockRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'chunk_type' => ['nullable', 'string', 'in:TITLE,PREAMBLE,BOOK,PART,CHAPTER,SECTION,ARTICLE,CLAUSE,PARAGRAPH,ITEM,DEFINITION,TRANSITIONAL_PROVISION,ANNEX,TABLE,NOTE,FOOTNOTE,SIGNATURE_BLOCK,OTHER'],
