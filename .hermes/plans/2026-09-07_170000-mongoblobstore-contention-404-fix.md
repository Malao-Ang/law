...
- **Message wording** ("being saved by another change, please retry") is user-facing English; if the UI is Thai, change to `กำลังบันทึกอยู่ กรุณาลองใหม่อีกครั้ง` for consistency — confirm preferred language.
